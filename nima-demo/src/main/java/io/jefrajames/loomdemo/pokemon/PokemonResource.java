 ...
 */
package io.jefrajames.loomdemo.pokemon;
...
public class PokemonResource {
    ...
    @Path("pinned/{timeout}")
    public String pinned(@PathParam("timeout") @DefaultValue(value = "5") Integer timeout) {
        ...
        synchronized(this) {
            ...
            return String.format("Hello from %s, sleep=%d%n", Thread.currentThread(), timeout);
        }
