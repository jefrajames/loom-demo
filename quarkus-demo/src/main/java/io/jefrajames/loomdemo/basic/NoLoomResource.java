...
public class NoLoomResource {
    ...
    @Inject
    public NoLoomResource(@ConfigProperty(name = "loom.sleep-seconds", defaultValue = "1") long sleepSeconds) {
    ...
    @GET
    @Path("/pinned/{timeout}")
    public String pinned(@PathParam("timeout") @DefaultValue("1000") Integer timeout) throws InterruptedException {
        synchronized (this) {
